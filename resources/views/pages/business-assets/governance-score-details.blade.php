<x-layouts::app :title="__('Governance Score Details')">
    <div class="space-y-6">
        ...
        <nav class="text-sm text-gray-500 dark:text-gray-400">
            ...
            <span class="mx-2">/</span>
            <span class="text-gray-900 dark:text-gray-100">{{ __('Governance Score Details') }}</span>
        </nav>
        ...
        @else
            <div class="bg-white dark:bg-zinc-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 text-center">
                <p class="text-gray-500 dark:text-gray-400">{{ __('No governance score available for this business asset.') }}</p>
            </div>
        @endif
    </div>
</x-layouts::app>